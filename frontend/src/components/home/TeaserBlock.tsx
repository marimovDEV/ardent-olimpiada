...
const TeaserBlock = () => {
    ...
    const imageUrl = config.teaser_image ? (config.teaser_image.startsWith('http') ? config.teaser_image : `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000'}${config.teaser_image}`) : null;
