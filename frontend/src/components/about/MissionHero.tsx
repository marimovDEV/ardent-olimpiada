        ...
        <section className="py-20 bg-gray-900 text-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10 text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur border border-white/20 mb-8 animate-fade-in">
                    ...
                    <span className="text-sm font-medium text-blue-100">Kelajak liderlari uchun</span>
                </div>

                <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight animate-slide-up">
                    Biz bilimni <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">sovg'aga</span> aylantiramiz
                </h1>

                <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-10 leading-relaxed animate-slide-up delay-100">
                    Olimpiada — bu shunchaki test emas. Bu — o‘quvchining mehnati, bilimi va kelajagi.
                    Biz shu yo‘lda <span className="text-white font-bold">halol, adolatli va zamonaviy</span> platformani yaratdik.
                </p>
