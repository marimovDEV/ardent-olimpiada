        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <Card className="shadow-sm border-gray-100">
                <CardHeader className="pb-2">
                    <CardTitle className="text-base font-bold">Ticket Kategoriyalari</CardTitle>
                    <CardDescription>Eng ko'p uchraydigan muammolar</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="h-[200px] w-full flex items-center justify-center">
                        <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                                ...
                                <Tooltip formatter={(value: number) => [`${value}%`, "Ulash"]} />
            ...
            <Card className="shadow-sm border-gray-100">
                <CardHeader className="pb-2">
                    <CardTitle className="text-base font-bold">Agent Samaradorligi</CardTitle>
                    <CardDescription>Haftalik murojaatlar statistikasi</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="h-[200px] w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={performanceData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                ...
                                <Bar dataKey="resolved" name="Hal qilingan" stackId="a" fill="#22c55e" radius={[0, 0, 4, 4]} barSize={20} />
                                <Bar dataKey="open" name="Ochiq" stackId="a" fill="#f87171" radius={[4, 4, 0, 0]} barSize={20} />
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
                </CardContent>
            ...
            <Card className="shadow-sm border-gray-100">
                <CardHeader className="pb-2">
                    <CardTitle className="text-base font-bold">Javob Berish Vaqti</CardTitle>
                    <CardDescription>O'rtacha daqiqada (min)</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="h-[200px] w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <LineChart data={responseTimeData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                ...
                                <XAxis dataKey="name" tick={{ fontSize: 10 }} tickLine={false} axisLine={false} />
                                <YAxis tick={{ fontSize: 10 }} tickLine={false} axisLine={false} />
                                <Tooltip cursor={{ fill: 'transparent' }} formatter={(value: number) => [`${value} min`, "Vaqt"]} />
