...
const HeroSection = () => {
  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-24 overflow-hidden bg-[#0B0F1A] min-h-[90vh] flex items-center">
      {/* Subtle Magic Background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute inset-0 opacity-40 md:opacity-100"
          style={{
            background: `radial-gradient(circle at 70% 40%, rgba(250,204,21,0.15), transparent 60%)`
          }}
        />
      ...
      <div className="container relative z-10 px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <motion.h1
                ...
                className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-black font-cinzel leading-[1.1] tracking-tight text-white"
              >
                Kelajagingizni <br />
          ...
          {/* Right: 3D Wizard Hero (Desktop Only) */}
