...
const MobileBottomNav = () => {
    ...
    return (
        <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#111827] border-t border-[#FACC15]/20 px-2 pb-safe-offset-1 pt-2 rounded-t-[20px] shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.4)]">
