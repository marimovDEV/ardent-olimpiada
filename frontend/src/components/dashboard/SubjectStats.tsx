                    ...
                    return (
                        ...
                        >
                            <motion.div
                                ...
                                className="bg-card border border-border rounded-2xl p-4 hover:shadow-lg hover:border-primary/30 transition-all group overflow-hidden relative cursor-pointer h-full"
                            >
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-[10px] font-bold text-muted-foreground uppercase">{t('dashboard.widgets.totalXP', 'Jami XP')}</p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-4 pt-4 border-t border-border/50 flex justify-between items-center opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0 duration-300">
                                    <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">{t('common.viewDetails', "Batafsil ko'rish")}</span>
